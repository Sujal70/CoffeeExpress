...
const Footer = () => {
  return (
    <footer className='footer ' id='footer'>
            ...
            <div className="footer__content">
                ...
                <ul className="footer_-contact">
                    <li className="footer__contact-item">
                        <AiOutlinePhone className='icon'/> +91 9997662175
                    </li>
                    <li className="footer__contact-item">
                        <MdOutlineLocationOn className='icon'/> 35/B Near Thomas Park Vasliganj / City  Saharanpur
                    </li>
                    <li className="footer__contact-item">
                        <FaRegEnvelope className='icon'/> kalrasujal36@gmail.com
                    </li>
          ...
          <p className="copyright__text">&copy; Copyright 2023 <span>CoffeeExpress by Sujal Kalra </span>All Rights Reserved. </p>
    </footer>
  )
}
